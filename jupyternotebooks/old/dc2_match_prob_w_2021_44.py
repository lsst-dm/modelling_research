...
butler = dafButler.Butler(
    ...
    collections=[
        ...
        'u/dtaranu/DM-32034/w_2021_44_match_0.5asec',
    ]
)
...
# For reference: pipetask command that ran the matching
# pipetask --long-log run -b /repo/dc2 --input 2.2i/runs/test-med-1/w_2021_44/DM-32391,2.2i/truth_summary
# --output "u/dtaranu/DM-32034/w_2021_44_match_0.5asec" -d "instrument = 'LSSTCam-imSim' and tract in (3828, 3829) and skymap='DC2'"
# -p /project/dtaranu/dc2/match_catalog_pipe/match_tract_catalog_probabilistic.yaml --register-dataset-types
