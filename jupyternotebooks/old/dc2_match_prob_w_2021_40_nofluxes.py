...
columns_errors_target = [f'{col}Err' for col in columns_data_target + ([] if use_fluxes else columns_fluxes_target)]
...
if not use_fluxes:
    columns_all_target.extend(columns_fluxes_target)
