...
butlers_dc2 = {
    '2.2i': dafButler.Butler('/repo/dc2', collections='2.2i/runs/test-med-1/w_2021_12/DM-29427'),
}
...
tract = 3828
tracts = {tract: ('/project/dtaranu/dc2_gen3/w_2021_12_gen2to3_multibandfit/calcats/', '2.2i')}
# i-band didn't work on w_2021_12 for some reason
filters_single = ('g', 'r', 'z')
filters_multi = ()
band_multi = None
name_skymap = 'DC2'
